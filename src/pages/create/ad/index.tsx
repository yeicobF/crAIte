  ...
  return (
    <>
      <SectionLayout>
        ...
        <div>Here you will create a new Advertising</div>
        <div className="grid w-full grid-cols-2 gap-4">
          ...
          >
            ...
            <div>
              <div className="mb-2 block">
                <label htmlFor="type">
                  What type of ad do I want to create?
                </label>
              </div>
              <input
                className="text-black"
            ...
            <div>
              <div className="mb-2 block">
                <label htmlFor="org">
                  What is the name of my organization?
                </label>
              </div>
              <input
                className="text-black"
            ...
            <div>
              <div className="mb-2 block">
                <label htmlFor="deadline">
                  When does the ad stop being valid?
                </label>
              </div>
              <input
                className="text-black"
          ...
          <div className="w-full flex-col gap-4"></div>
        </div>
